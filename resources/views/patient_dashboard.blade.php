            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-4"><a href="{{url('/book_appointment')}}" class="btn btn-primary float-right">Book Appointment</a></div>
                    </div>
...
<div class="modal fade" id="appointmentStatus" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
function getlist()
{
    ...
    columns: [
        ...
        { data: 'id',render:function(data,type,row){ 
            return `<button type="button" class="btn btn-primary" onclick="changestatus(${data},${row.dr_status})"> <span class="fa fa-edit"></span></button>`
        } 
         },
    ]
});
